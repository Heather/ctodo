...
int main(int argc, char* argv[]) {
    if (argc < 2) return ctodo_read(-1);
        ...
        if ((strcmp(argv[1], "--version") == 0) || (strcmp(argv[1], "-v") == 0)) {
            ...
            else return ctodo_read(atoi(argv[2]));
            }
            ...
            if (argc < 3) {
                ...
                sprintf(db, "%s", argv[2]);
#endif
                if (argc < 4) return ctodo_read_custom(-1, db);
                else {
                    if (strcmp(argv[3], "--list") == 0) {
                        ...
                        else return ctodo_read_custom(atoi(argv[4]), db);
                        }
            ...
            if (custom == 0) return todo_write(argv, argc, list);
            else return todo_write_custom(argv, argc, list, db);
        }   }
    todo_close();
    }
//________________________________________________________________________________
